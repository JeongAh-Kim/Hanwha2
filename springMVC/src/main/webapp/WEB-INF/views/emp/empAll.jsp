...
<html>
	...
	<body>
		<h1>직원목록.............</h1>
		<button onclick="location.href='empinsert'">직원신규등록</button>
		<br><br>
		<table border="1">
		<tr>
			<td>직원번호</td><td>직원이름</td><td>직원성</td><td>이메일</td>
			<td>전화번호</td><td>급여</td><td>입사일</td><td>매니저</td>
			<td>부서</td><td>커미션</td><td>직무</td>
		</tr>
